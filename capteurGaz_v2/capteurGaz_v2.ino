...
int READ_SAMPLE_TIMES = 1;                            //define the time interal(in milisecond) between each samples in
                                                    //normal operation
...
void loop()
{  
  unsigned long iPPM_LPG = 0;
  unsigned long iPPM_CO = 0;
  unsigned long iPPM_Smoke = 0;
  float ratio_gas;
  
  ratio_gas = MQRead(MQ_PIN/Ro);
  ...
  Serial.print("Ratio de gaz ");
  Serial.println(ratio_gas);
